...
execute as @a[scores={tobi_defensive=1,tobi_defensive_mode=1,tobi_has_armor=1,tobi_genjutsu_sneak_freeze=0},predicate=tobi:is_sneaking] run scoreboard players set @s tobi_genjutsu_sneak_freeze 1
...
execute as @a[scores={tobi_genjutsu_sneak_freeze=1}] run scoreboard players set @s tobi_genjutsu_sneak_timer 100
