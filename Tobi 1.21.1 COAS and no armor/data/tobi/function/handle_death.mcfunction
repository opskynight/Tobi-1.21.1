...
execute as @a[tag=tobi_abilities_enabled,scores={tobi_death=1..}] run effect give @s minecraft:night_vision infinite 0 true
execute as @a[tag=tobi_abilities_enabled,scores={tobi_death=1..}] run effect give @s minecraft:saturation infinite 0 true
