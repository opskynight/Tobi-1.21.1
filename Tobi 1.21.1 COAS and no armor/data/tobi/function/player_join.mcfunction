...
execute unless score @s tobi_genjutsu_sneak_timer = @s tobi_genjutsu_sneak_timer run scoreboard players set @s tobi_genjutsu_sneak_timer 0
...
execute unless score @s tobi_short_range_charge = @s tobi_short_range_charge run scoreboard players set @s tobi_short_range_charge 0
execute unless score @s tobi_short_range_cooldown = @s tobi_short_range_cooldown run scoreboard players set @s tobi_short_range_cooldown 0
...
execute unless score @s tobi_kamui_kidnap_charge = @s tobi_kamui_kidnap_charge run scoreboard players set @s tobi_kamui_kidnap_charge 0
execute unless score @s tobi_kamui_kidnap_cooldown = @s tobi_kamui_kidnap_cooldown run scoreboard players set @s tobi_kamui_kidnap_cooldown 0
execute unless score @s tobi_return_cooldown = @s tobi_return_cooldown run scoreboard players set @s tobi_return_cooldown 0
execute unless score @s tobi_return_charge = @s tobi_return_charge run scoreboard players set @s tobi_return_charge 0
...
execute unless score @s tobi_dimension_charge = @s tobi_dimension_charge run scoreboard players set @s tobi_dimension_charge 0
...
# Waypoint scores
execute unless score @s tobi_waypoint_charge = @s tobi_waypoint_charge run scoreboard players set @s tobi_waypoint_charge 0
