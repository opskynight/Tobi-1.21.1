...
# ============================================
# Sneak freeze active
execute as @a[scores={tobi_defensive=1,tobi_defensive_mode=1,tobi_genjutsu_sneak_freeze=2,tobi_enabled=1}] run title @s actionbar [{"text":"◉ AREA FREEZE: ","color":"red","bold":true},{"score":{"name":"@s","objective":"tobi_charge"},"color":"gold"},{"text":"t remaining ◉","color":"red"}]
