...
execute as @a[scores={tobi_offensive_mode=3,tobi_has_armor=1,tobi_kamui_charge=0,tobi_kamui_active=0}] run title @s actionbar {"text":"◈ TRAVEL: SNEAK 5s for Spectator ◈","color":"aqua","bold":true}
