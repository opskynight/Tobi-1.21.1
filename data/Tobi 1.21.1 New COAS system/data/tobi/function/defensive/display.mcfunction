...
execute as @a[scores={tobi_defensive=1,tobi_defensive_mode=0,tobi_phase=0,tobi_has_armor=1}] run title @s actionbar {"text":"▰▰▰ INVULNERABILITY ACTIVE ▰▰▰","color":"dark_red","bold":true}

# ============================================
# MODE 1: GENJUTSU
# ============================================
# Sneak freeze active
execute as @a[scores={tobi_defensive=1,tobi_defensive_mode=1,tobi_genjutsu_sneak_freeze=2,tobi_has_armor=1}] run title @s actionbar [{"text":"◉ AREA FREEZE: ","color":"red","bold":true},{"score":{"name":"@s","objective":"tobi_genjutsu_sneak_timer"},"color":"gold"},{"text":"t remaining ◉","color":"red"}]

# Normal genjutsu mode
execute as @a[scores={tobi_defensive=1,tobi_defensive_mode=1,tobi_genjutsu_sneak_freeze=..1,tobi_has_armor=1}] run title @s actionbar {"text":"◉ GENJUTSU - AIM/SNEAK/CLICK ◉","color":"red","bold":true}
