# ============================================
# KAMUI DIMENSIONAL STYLE - MAIN CONTROLLER - FIXED
# ============================================
# Routes to appropriate mode based on dimensional_mode score

# ============================================
# CRITICAL FIX: SAFETY CHECK FIRST
# ============================================
# This prevents players from getting stuck if they lose their tag
function tobi:dimensional/kamui_dimension/safety_check_void_mode
