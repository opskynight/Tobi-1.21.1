...
execute as @a[scores={tobi_offensive=1,tobi_offensive_mode=3,tobi_has_armor=1},predicate=tobi:is_sneaking,gamemode=survival] run scoreboard players add @s tobi_kamui_charge 1
...
execute as @a[scores={tobi_offensive=1,tobi_offensive_mode=3,tobi_kamui_charge=1..99},predicate=tobi:is_sneaking] run title @s actionbar {"text":"⬤ CHARGING SPECTATOR MODE ⬤","color":"aqua","bold":true}
